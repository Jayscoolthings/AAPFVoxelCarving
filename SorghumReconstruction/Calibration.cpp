...
// Used for camera orientation problems
...
bool autoCalibrationSideImage(const QString& input, const QString& output)
{
	...
	// old pot location: const cv::Rect potLocation(1043, 1672, 363, 214);
	// New pot location:
	const cv::Rect potLocation(1084, 1747, 287, 148);
...
bool autoCalibrationTopImage(const QString& input, const QString& output)
{
	...
	const cv::Mat segmentationMaskTopImage(calibrationTopImage.rows,
		                                   ...
		                                   cv::Scalar(255, 255, 255));
	// old pot top location: const cv::Rect potTopLocation(1001, 800, 454, 453);
	// New pot location:
	const cv::Rect potTopLocation(1143, 944, 167, 166);
